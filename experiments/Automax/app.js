...
app.readServices = function(device)
{
	device.readServices(
		[
		app.automax.ACCELEROMETER_SERVICE, // Accelerometer service UUID.
		],
...
app.getAccelerometerValues = function(data)
{
	...
	var rawX = evothings.util.bigEndianToInt16(data, 6);
	var rawY = evothings.util.bigEndianToInt16(data, 8);
	var rawZ = evothings.util.bigEndianToInt16(data, 10);
	var ax = rawX / divisor;
	var ay = rawY / divisor;
	var az = rawZ / divisor;
